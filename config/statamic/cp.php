...
return [
    ...
    */
    ...
    'custom_cms_name' => env('STATAMIC_CUSTOM_CMS_NAME', 'admin'),
    'custom_css_url' => env('STATAMIC_CUSTOM_CSS_URL', null),
    'custom_logo_url' => env('STATAMIC_CUSTOM_LOGO_URL', "/assets/admin/logo-starter-light.svg"),
    'custom_dark_logo_url' => env('STATAMIC_CUSTOM_DARK_LOGO_URL', "/assets/admin/logo-starter-dark.svg"),
    //'custom_favicon_url' => env('STATAMIC_CUSTOM_FAVICON_URL', "/favicon-32x32.png"),
    /*
    |--------------------------------------------------------------------------
    | Thumbnails
    |--------------------------------------------------------------------------
